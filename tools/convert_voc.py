...
def main():
    ...
    filename_list=tf.train.match_filenames_once("/Users/justinbutler/Desktop/school/Calgary/Thesis Work/ML_Testing/yolov3-tf2/train/Annotations/*.xml")
