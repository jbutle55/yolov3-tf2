...
flags.DEFINE_string('classes', '/Users/justinbutler/Desktop/school/Calgary/ML_Work/yolov3-tf2/classes.names', 'classes file')
...
def main(_argv):
    ...
    image_list = open(os.path.join(FLAGS.data_dir, 'img_set.txt')).read().splitlines()
